...
- To set your game mode (Keysanity, Inverted, Entrance, Door Rando, etc) click the Gear icon in the `Items` section of the tracker; there you will see the various options that can be toggled.
