...
function Setting:updateSetting()
    ...
    elseif self.file == "layout.lua" then
        ...
        elseif self.textcode == "CONFIG.LAYOUT_SHOW_MAP_GRIDLINES" then
            CONFIG.LAYOUT_SHOW_MAP_GRIDLINES = self:getState()
    ...
    elseif self.file == "tracking.lua" then
        ...
        elseif self.textcode == "CONFIG.AUTOTRACKER_DISABLE_ROM_HEADER" then
            CONFIG.AUTOTRACKER_DISABLE_ROM_HEADER = self:getState()
        end
