...
function GTCrystalReq:updateIcon()
    ...
    if self:getState() == 8 then
        self.ItemInstance.Icon =
            ImageReference:FromPackRelativePath("images/GTSign.png", "overlay|images/overlayNA.png")
        item.AcquiredCount = 7
    else
        if self:getState() == 0 then
            self.ItemInstance.Icon =
                ImageReference:FromPackRelativePath("images/GTSign.png", "overlay|images/overlay0.png")
        elseif self:getState() == 1 then
            self.ItemInstance.Icon =
                ImageReference:FromPackRelativePath("images/GTSign.png", "overlay|images/overlay1.png")
        elseif self:getState() == 2 then
            self.ItemInstance.Icon =
                ImageReference:FromPackRelativePath("images/GTSign.png", "overlay|images/overlay2.png")
        elseif self:getState() == 3 then
            self.ItemInstance.Icon =
                ImageReference:FromPackRelativePath("images/GTSign.png", "overlay|images/overlay3.png")
        elseif self:getState() == 4 then
            self.ItemInstance.Icon =
                ImageReference:FromPackRelativePath("images/GTSign.png", "overlay|images/overlay4.png")
        elseif self:getState() == 5 then
            self.ItemInstance.Icon =
                ImageReference:FromPackRelativePath("images/GTSign.png", "overlay|images/overlay5.png")
        elseif self:getState() == 6 then
            self.ItemInstance.Icon =
                ImageReference:FromPackRelativePath("images/GTSign.png", "overlay|images/overlay6.png")
        elseif self:getState() == 7 then
            self.ItemInstance.Icon =
                ImageReference:FromPackRelativePath("images/GTSign.png", "overlay|images/overlay7.png")
        end
