...
if Tracker.ActiveVariantUID == "items_only" then
    ...
    KeysanityMode("Map", "")
    KeysanityMode("Map", "_small")
    KeysanityMode("Compass", "")
    KeysanityMode("Compass", "_small")
    KeysanityMode("Small Key", "")
    KeysanityMode("Small Key", "_small")
    KeysanityMode("Big Key", "")
    KeysanityMode("Big Key", "_small")
    EntranceShuffleMode("")
