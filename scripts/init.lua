...
if Tracker.ActiveVariantUID == "items_only" then
    ...
    WorldStateMode(false)
    WorldStateMode(true)
    KeysanityMode(false, "Map")
    KeysanityMode(true, "Map")
    KeysanityMode(false, "Compass")
    KeysanityMode(true, "Compass")
    KeysanityMode(false, "Small Key")
    KeysanityMode(true, "Small Key")
    KeysanityMode(false, "Big Key")
    KeysanityMode(true, "Big Key")
    EntranceShuffleMode(false)
    EntranceShuffleMode(true)
    DoorShuffleMode(false)
    DoorShuffleMode(true)
    RetroMode(false)
    RetroMode(true)
    RaceMode(false)
    RaceMode(true)
