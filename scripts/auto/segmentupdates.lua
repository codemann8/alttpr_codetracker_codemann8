...
function updateRoomsFromMemorySegment(segment)
    ...
    if OBJ_RACEMODE.CurrentStage == 0 then
        ...
        updateSectionChestCountFromRoomSlotList(segment, "@Ice Palace/Kholdstare", {{222, 11}})
        ...
        updateSectionChestCountFromRoomSlotList(segment, "@HC Key Guard/Chest", {{114, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@HC Key Guard/Guard", {{114, 10}})
        updateSectionChestCountFromRoomSlotList(segment, "@HC Boomerang/Chest", {{113, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@HC Boomerang/Guard", {{113, 10}})
        updateSectionChestCountFromRoomSlotList(segment, "@HC Ball 'N Chain/Guard", {{128, 10}})
        updateSectionChestCountFromRoomSlotList(segment, "@HC Prison/Chest", {{128, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@HC Dark Cross/Chest", {{50, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@HC Key Rat/Rat", {{33, 10}})
        updateSectionChestCountFromRoomSlotList(segment, "@HC Back/Chest", {{17, 4}, {17, 5}, {17, 6}})
        updateSectionChestCountFromRoomSlotList(segment, "@HC Sanctuary/Chest", {{18, 4}})
        ...
        updateSectionChestCountFromRoomSlotList(segment, "@EP Dark Pot/Pot", {{186, 10}})
        updateSectionChestCountFromRoomSlotList(segment, "@EP Big Key Chest/Chest", {{184, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@EP Big Chest/Chest", {{169, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@EP Dark Eyegore/Eyegore", {{153, 10}})
        updateSectionChestCountFromRoomSlotList(segment, "@EP Armos/Prize", {{200, 11}})

        updateSectionChestCountFromRoomSlotList(segment, "@DP Eyegore Switch/Chest", {{116, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@DP Popo Chest/Chest", {{133, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@DP Cannonball/Chest", {{117, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@DP Torch/Torch", {{115, 10}})
        updateSectionChestCountFromRoomSlotList(segment, "@DP Big Chest/Chest", {{115, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@DP Back Lobby/Pot", {{99, 10}})
        updateSectionChestCountFromRoomSlotList(segment, "@DP Beamos Hall/Pot", {{83, 10}})
        updateSectionChestCountFromRoomSlotList(segment, "@DP Back Tiles/Pot", {{67, 10}})
        updateSectionChestCountFromRoomSlotList(segment, "@DP Lanmolas/Prize", {{51, 11}})

        updateSectionChestCountFromRoomSlotList(segment, "@TH Lobby/Chest", {{135, 10}})
        updateSectionChestCountFromRoomSlotList(segment, "@TH Cage/Item", {{119, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@TH Basement/Chest", {{135, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@TH Compass Chest/Chest", {{39, 5}})
        updateSectionChestCountFromRoomSlotList(segment, "@TH Big Chest/Chest", {{39, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@TH Moldorm/Prize", {{7, 11}})

        updateSectionChestCountFromRoomSlotList(segment, "@AT Lobby/Chest", {{224, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@AT Dark Chest/Chest", {{208, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@AT Bow Guard/Guard", {{192, 10}})
        updateSectionChestCountFromRoomSlotList(segment, "@AT Circle of Pots/Guard", {{176, 10}})

        updateSectionChestCountFromRoomSlotList(segment, "@PoD Shooter/Chest", {{9, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@PoD Bow Side/Chest", {{43, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@PoD Arena Ledge/Chest", {{42, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@PoD Arena/Chest", {{42, 5}})
        updateSectionChestCountFromRoomSlotList(segment, "@PoD Stalfos Basement/Chest", {{10, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@PoD Big Key Chest/Chest", {{58, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@PoD Dark Maze/Chest", {{25, 4}, {25, 5}})
        updateSectionChestCountFromRoomSlotList(segment, "@PoD Big Chest/Chest", {{26, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@PoD Turtle Room/Chest", {{26, 5}})
        updateSectionChestCountFromRoomSlotList(segment, "@PoD Rupee Basement/Chest", {{106, 4}, {106, 5}})
        updateSectionChestCountFromRoomSlotList(segment, "@PoD Harmless Hellway/Chest", {{26, 6}})
        updateSectionChestCountFromRoomSlotList(segment, "@PoD Helmasaur/Prize", {{90, 11}})

        updateSectionChestCountFromRoomSlotList(segment, "@SP Entrance/Chest", {{40, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@SP Bomb Wall/Chest", {{55, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@SP Pot Row/Pot", {{56, 10}})
        updateSectionChestCountFromRoomSlotList(segment, "@SP Front Flood Pot/Pot", {{55, 10}})
        updateSectionChestCountFromRoomSlotList(segment, "@SP Hookshot Pot/Pot", {{54, 10}})
        updateSectionChestCountFromRoomSlotList(segment, "@SP South Side/Chest", {{70, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@SP Big Chest/Chest", {{54, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@SP Left Flood Pot/Pot", {{53, 10}})
        ...
        updateSectionChestCountFromRoomSlotList(segment, "@SP Waterway/Pot", {{22, 10}})
        updateSectionChestCountFromRoomSlotList(segment, "@SP Arrghus/Prize", {{6, 11}})
        ...
        updateSectionChestCountFromRoomSlotList(segment, "@SW Big Chest/Chest", {{88, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@SW Statue Switch/Chest", {{87, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@SW West Lobby/Pot", {{86, 10}})
        updateSectionChestCountFromRoomSlotList(segment, "@SW Bridge/Chest", {{89, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@SW Gibdo/Gibdo", {{57, 10}})
        updateSectionChestCountFromRoomSlotList(segment, "@SW Mothula/Prize", {{41, 11}})

        updateSectionChestCountFromRoomSlotList(segment, "@TT Main Lobby/Chest", {{219, 4}, {219, 5}, {203, 4}, {220, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@TT Ambush/Chest", {{219, 4}, {219, 5}, {203, 4}, {220, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@TT SE Lobby/Chest", {{219, 4}, {219, 5}, {203, 4}, {220, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@TT Big Key Chest/Chest", {{219, 4}, {219, 5}, {203, 4}, {220, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@TT Hallway/Pot", {{188, 10}})
        updateSectionChestCountFromRoomSlotList(segment, "@TT Spike Switch/Pot", {{171, 10}})
        updateSectionChestCountFromRoomSlotList(segment, "@TT Attic/Chest", {{101, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@TT Prison Cell/Chest", {{69, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@TT Big Chest/Chest", {{68, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@TT Blind/Prize", {{172, 11}})

        updateSectionChestCountFromRoomSlotList(segment, "@IP Lobby/Bari", {{14, 10}})
        updateSectionChestCountFromRoomSlotList(segment, "@IP Pengator Room/Chest", {{46, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@IP Conveyor/Bari", {{62, 10}})
        updateSectionChestCountFromRoomSlotList(segment, "@IP Spike Room/Chest", {{95, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@IP Ice Breaker/Chest", {{31, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@IP Tongue Pull/Boulder", {{63, 10}})
        updateSectionChestCountFromRoomSlotList(segment, "@IP Tongue Pull/Chest", {{63, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@IP Freezor/Chest", {{126, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@IP Ice T/Chest", {{174, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@IP Big Chest/Chest", {{158, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@IP Hell on Ice/Pot", {{159, 10}})
        updateSectionChestCountFromRoomSlotList(segment, "@IP Kholdstare/Prize", {{222, 11}})

        updateSectionChestCountFromRoomSlotList(segment, "@MM Bridge/Chest", {{162, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@MM Spike Room/Chest", {{179, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@MM Spike Room/Pot", {{179, 10}})
        updateSectionChestCountFromRoomSlotList(segment, "@MM Fishbone Room/Pot", {{161, 10}})
        updateSectionChestCountFromRoomSlotList(segment, "@MM Main Hub/Chest", {{194, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@MM Conveyor Switch/Bari", {{193, 10}})
        ...
        updateSectionChestCountFromRoomSlotList(segment, "@MM Blue Pegs/Chest", {{195, 5}})
        updateSectionChestCountFromRoomSlotList(segment, "@MM Big Chest/Chest", {{195, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@MM Vitreous/Prize", {{144, 11}})

        updateSectionChestCountFromRoomSlotList(segment, "@TR Compass Chest/Chest", {{214, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@TR Roller Room/Chest", {{183, 4}, {183, 5}})
        updateSectionChestCountFromRoomSlotList(segment, "@TR Chain Chomp/Pokey", {{182, 10}})
        updateSectionChestCountFromRoomSlotList(segment, "@TR Chain Chomp/Chest", {{182, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@TR Lava Pokey/Pokey", {{19, 10}})
        updateSectionChestCountFromRoomSlotList(segment, "@TR Lava/Chest", {{20, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@TR Big Chest/Chest", {{36, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@TR Crystaroller/Chest", {{4, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@TR Laser Bridge/Chest", {{213, 4}, {213, 5}, {213, 6}, {213, 7}})
        updateSectionChestCountFromRoomSlotList(segment, "@TR Trinexx/Prize", {{164, 11}})

        updateSectionChestCountFromRoomSlotList(segment, "@GT Hope Room/Chest", {{140, 5}, {140, 6}})
        updateSectionChestCountFromRoomSlotList(segment, "@GT Torch/Torch", {{140, 3}})
        updateSectionChestCountFromRoomSlotList(segment, "@GT Conveyor Bumper/Pot", {{139, 10}})
        updateSectionChestCountFromRoomSlotList(segment, "@GT Stalfos Room/Chest", {{123, 4}, {123, 5}, {123, 6}, {123, 7}})
        updateSectionChestCountFromRoomSlotList(segment, "@GT Map Chest/Chest", {{139, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@GT Double Switch/Pot", {{155, 10}})
        updateSectionChestCountFromRoomSlotList(segment, "@GT Firesnake/Chest", {{125, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@GT Rando Room/Chest", {{124, 4}, {124, 5}, {124, 6}, {124, 7}})
        updateSectionChestCountFromRoomSlotList(segment, "@GT Compass Room/Chest", {{157, 4}, {157, 5}, {157, 6}, {157, 7}})
        updateSectionChestCountFromRoomSlotList(segment, "@GT Post-Compass/Pot", {{123, 10}})
        ...
        updateSectionChestCountFromRoomSlotList(segment, "@GT Tile Room/Chest", {{141, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@GT Big Chest/Chest", {{140, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@GT Mini Helmasaur/Chest", {{61, 4}, {61, 5}})
        updateSectionChestCountFromRoomSlotList(segment, "@GT Mini Helmasaur/Mini Helmasaur", {{61, 10}})
        updateSectionChestCountFromRoomSlotList(segment, "@GT Pre-Moldorm/Chest", {{61, 6}})
        updateSectionChestCountFromRoomSlotList(segment, "@GT Validation/Chest", {{77, 4}})
    end
