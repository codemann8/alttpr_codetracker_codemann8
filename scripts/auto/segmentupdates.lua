...
function updateRoomsFromMemorySegment(segment)
    ...
    if OBJ_RACEMODE.CurrentStage == 0 then
        ...
        updateSectionChestCountFromRoomSlotList(segment, {"@Thieves Town/Lobby", "@TT Main Lobby/Chest"}, {{219, 4}})
        ...
        updateSectionChestCountFromRoomSlotList(segment, {"@Misery Mire/Torch Tiles", "@MM Torch Tiles/Chest"}, {{193, 4}})
