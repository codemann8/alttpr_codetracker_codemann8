...
function updateRoomsFromMemorySegment(segment)
    ...
    if OBJ_RACEMODE.CurrentStage == 0 then
        ...
        updateSectionChestCountFromRoomSlotList(segment, "@Palace of Darkness/King Helmasaur", {{90, 11}})
        ...
        updateSectionChestCountFromRoomSlotList(segment, "@PoD King Helmasaur/Prize", {{90, 11}})
