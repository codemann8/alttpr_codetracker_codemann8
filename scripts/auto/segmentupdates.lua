...
function updateRoomsFromMemorySegment(segment)
    ...
    if OBJ_RACEMODE.CurrentStage == 0 then
        ...
        updateSectionChestCountFromRoomSlotList(segment, "@Hyrule Castle & Escape/First", {{114, 4}}, "@HC Key Guard/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Hyrule Castle & Escape/Boomerang", {{113, 4}}, "@HC Boomerang/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Hyrule Castle & Escape/Prison", {{128, 4}}, "@HC Prison/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Hyrule Castle & Escape/Dark Cross", {{50, 4}}, "@HC Dark Cross/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Hyrule Castle & Escape/Back", {{17, 4}, {17, 5}, {17, 6}}, "@HC Back/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Hyrule Castle & Escape/Sanctuary", {{18, 4}}, "@HC Sanctuary/Chest")

        updateSectionChestCountFromRoomSlotList(segment, "@Eastern Palace/Front", {{185, 4}, {170, 4}, {168, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@Eastern Palace/Big Chest", {{169, 4}}, "@EP Big Chest/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Eastern Palace/Big Key Chest", {{184, 4}}, "@EP Big Key Chest/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Eastern Palace/Armos", {{200, 11}}, "@EP Armos/Prize")

        updateSectionChestCountFromRoomSlotList(segment, "@Desert Palace/Eyegore Switch", {{116, 4}}, "@DP Eyegore Switch/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Desert Palace/Popo Chest", {{133, 4}}, "@DP Popo Chest/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Desert Palace/Cannonball Chest", {{117, 4}}, "@DP Cannonball/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Desert Palace/Torch", {{115, 10}}, "@DP Torch/Torch")
        updateSectionChestCountFromRoomSlotList(segment, "@Desert Palace/Big Chest", {{115, 4}}, "@DP Big Chest/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Desert Palace/Lanmolas", {{51, 11}}, "@DP Lanmolas/Prize")

        updateSectionChestCountFromRoomSlotList(segment, "@Tower of Hera/Lobby\\Cage", {{135, 10}, {119, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@Tower of Hera/Basement", {{135, 4}}, "@TH Basement/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Tower of Hera/Compass Chest", {{39, 5}}, "@TH Compass Chest/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Tower of Hera/Big Chest", {{39, 4}}, "@TH Big Chest/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Tower of Hera/Moldorm", {{7, 11}}, "@TH Moldorm/Prize")

        updateSectionChestCountFromRoomSlotList(segment, "@Agahnim's Tower/Lobby", {{224, 4}}, "@AT Lobby/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Agahnim's Tower/Dark Chest", {{208, 4}}, "@AT Dark Chest/Chest")

        updateSectionChestCountFromRoomSlotList(segment, "@Palace of Darkness/Shooter Chest", {{9, 4}}, "@PoD Shooter/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Palace of Darkness/Bow Side", {{43, 4}}, "@PoD Bow Side/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Palace of Darkness/Arena Ledge", {{42, 4}}, "@PoD Arena Ledge/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Palace of Darkness/Arena Chest", {{42, 5}}, "@PoD Arena/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Palace of Darkness/Stalfos Basement", {{10, 4}}, "@PoD Stalfos Basement/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Palace of Darkness/Big Key Chest", {{58, 4}}, "@PoD Big Key Chest/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Palace of Darkness/Dark Maze", {{25, 4}, {25, 5}}, "@PoD Dark Maze/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Palace of Darkness/Big Chest", {{26, 4}}, "@PoD Big Chest/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Palace of Darkness/Turtle Room", {{26, 5}}, "@PoD Turtle Room/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Palace of Darkness/Rupee Basement", {{106, 4}, {106, 5}}, "@PoD Rupee Basement/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Palace of Darkness/Harmless Hellway", {{26, 6}}, "@PoD Harmless Hellway/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Palace of Darkness/King Helmasaur", {{90, 11}}, "@PoD King Helmasaur/Prize")

        updateSectionChestCountFromRoomSlotList(segment, "@Swamp Palace/Entrance Chest", {{40, 4}}, "@SP Entrance/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Swamp Palace/Bomb Wall", {{55, 4}}, "@SP Bomb Wall/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Swamp Palace/South Side", {{70, 4}}, "@SP South Side/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Swamp Palace/Left Side", {{53, 4}, {52, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@Swamp Palace/Big Chest", {{54, 4}}, "@SP Big Chest/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Swamp Palace/Back", {{118, 4}, {118, 5}, {102, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@Swamp Palace/Arrghus", {{6, 11}}, "@SP Arrghus/Prize")

        updateSectionChestCountFromRoomSlotList(segment, "@Skull Woods/Front", {{103, 4}, {104, 4}, {87, 4}, {87, 5}, {88, 5}})
        updateSectionChestCountFromRoomSlotList(segment, "@Skull Woods/Big Chest", {{88, 4}}, "@SW Big Chest/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Skull Woods/Bridge", {{89, 4}}, "@SW Bridge/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Skull Woods/Mothula", {{41, 11}}, "@SW Mothula/Prize")

        updateSectionChestCountFromRoomSlotList(segment, "@Thieves Town/Front", {{219, 4}, {219, 5}, {203, 4}, {220, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@Thieves Town/Attic Chest", {{101, 4}}, "@TT Attic/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Thieves Town/Prison Cell", {{69, 4}}, "@TT Prison Cell/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Thieves Town/Big Chest", {{68, 4}}, "@TT Big Chest/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Thieves Town/Blind", {{172, 11}}, "@TT Blind/Prize")

        updateSectionChestCountFromRoomSlotList(segment, "@Ice Palace/Pengator Room", {{46, 4}}, "@IP Pengator Room/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Ice Palace/Spike Room", {{95, 4}}, "@IP Spike Room/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Ice Palace/Ice Breaker", {{31, 4}}, "@IP Ice Breaker/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Ice Palace/Tongue Pull", {{63, 4}}, "@IP Tongue Pull/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Ice Palace/Freezor Chest", {{126, 4}}, "@IP Freezor/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Ice Palace/Ice T", {{174, 4}}, "@IP Ice T/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Ice Palace/Big Chest", {{158, 4}}, "@IP Big Chest/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Ice Palace/Kholdstare", {{222, 11}}, "@IP Kholdstare/Prize")

        updateSectionChestCountFromRoomSlotList(segment, "@Misery Mire/Spike Switch", {{179, 4}}, "@MM Spike Room/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Misery Mire/Bridge", {{162, 4}}, "@MM Bridge/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Misery Mire/Main Hub", {{194, 4}}, "@MM Main Hub/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Misery Mire/Left Side", {{193, 4}, {209, 4}})
        updateSectionChestCountFromRoomSlotList(segment, "@Misery Mire/Blue Peg Chest", {{195, 5}}, "@MM Blue Pegs/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Misery Mire/Big Chest", {{195, 4}}, "@MM Big Chest/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Misery Mire/Vitreous", {{144, 11}}, "@MM Vitreous/Prize")

        updateSectionChestCountFromRoomSlotList(segment, "@Turtle Rock/Compass Room", {{214, 4}}, "@TR Compass Chest/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Turtle Rock/Roller Room", {{183, 4}, {183, 5}}, "@TR Roller Room/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Turtle Rock/Chain Chomp", {{182, 4}}, "@TR Chain Chomp/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Turtle Rock/Lava Chest", {{20, 4}}, "@TR Lava/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Turtle Rock/Big Chest", {{36, 4}}, "@TR Big Chest/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Turtle Rock/Crystaroller Chest", {{4, 4}}, "@TR Crystaroller/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Turtle Rock/Laser Bridge", {{213, 4}, {213, 5}, {213, 6}, {213, 7}}, "@TR Laser Bridge/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Turtle Rock/Trinexx", {{164, 11}}, "@TR Trinexx/Prize")

        updateSectionChestCountFromRoomSlotList(segment, "@Ganon's Tower/Hope Room", {{140, 5}, {140, 6}}, "@GT Hope Room/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Ganon's Tower/Torch", {{140, 3}}, "@GT Torch/Torch")
        updateSectionChestCountFromRoomSlotList(segment, "@Ganon's Tower/Stalfos Room", {{123, 4}, {123, 5}, {123, 6}, {123, 7}}, "@GT Stalfos Room/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Ganon's Tower/Map Chest", {{139, 4}}, "@GT Map Chest/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Ganon's Tower/Firesnake", {{125, 4}}, "@GT Firesnake/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Ganon's Tower/Rando Room", {{124, 4}, {124, 5}, {124, 6}, {124, 7}}, "@GT Rando Room/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Ganon's Tower/Compass Room", {{157, 4}, {157, 5}, {157, 6}, {157, 7}}, "@GT Compass Room/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Ganon's Tower/Bob\\Ice Armos", {{140, 7}, {28, 4}, {28, 5}, {28, 6}})
        updateSectionChestCountFromRoomSlotList(segment, "@Ganon's Tower/Tile Room", {{141, 4}}, "@GT Tile Room/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Ganon's Tower/Big Chest", {{140, 4}}, "@GT Big Chest/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Ganon's Tower/Mini Helmasaur", {{61, 4}, {61, 5}}, "@GT Mini Helmasaur/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Ganon's Tower/Pre-Moldorm", {{61, 6}}, "@GT Pre-Moldorm/Chest")
        updateSectionChestCountFromRoomSlotList(segment, "@Ganon's Tower/Validation", {{77, 4}}, "@GT Validation/Chest")

        --Key Drop Locations
        if OBJ_POOL and OBJ_POOL.CurrentStage > 0 then
            updateSectionChestCountFromRoomSlotList(segment, "@Hyrule Castle & Escape/Key Guard", {{114, 10}}, "@HC Key Guard/Guard")
            updateSectionChestCountFromRoomSlotList(segment, "@Hyrule Castle & Escape/Boomerang Guard", {{113, 10}}, "@HC Boomerang/Guard")
            updateSectionChestCountFromRoomSlotList(segment, "@Hyrule Castle & Escape/Ball 'N Chain Guard", {{128, 10}}, "@HC Ball 'N Chain/Guard")
            updateSectionChestCountFromRoomSlotList(segment, "@Hyrule Castle & Escape/Key Rat", {{33, 10}}, "@HC Key Rat/Rat")

            updateSectionChestCountFromRoomSlotList(segment, "@Eastern Palace/Dark Pot Key", {{186, 10}}, "@EP Dark Pot/Pot")
            updateSectionChestCountFromRoomSlotList(segment, "@Eastern Palace/Dark Eyegore", {{153, 10}}, "@EP Dark Eyegore/Eyegore")

            updateSectionChestCountFromRoomSlotList(segment, "@Desert Palace/Back Lobby Key", {{99, 10}}, "@DP Back Lobby/Pot")
            updateSectionChestCountFromRoomSlotList(segment, "@Desert Palace/Beamos Hall Key", {{83, 10}}, "@DP Beamos Hall/Pot")
            updateSectionChestCountFromRoomSlotList(segment, "@Desert Palace/Back Tiles Key", {{67, 10}}, "@DP Back Tiles/Pot")

            updateSectionChestCountFromRoomSlotList(segment, "@Agahnim's Tower/Bow Guard", {{192, 10}}, "@AT Bow Guard/Guard")
            updateSectionChestCountFromRoomSlotList(segment, "@Agahnim's Tower/Circle of Pots Key", {{176, 10}}, "@AT Circle of Pots/Guard")

            updateSectionChestCountFromRoomSlotList(segment, "@Swamp Palace/Pot Row Key", {{56, 10}}, "@SP Pot Row/Pot")
            updateSectionChestCountFromRoomSlotList(segment, "@Swamp Palace/Front Flood Key", {{55, 10}}, "@SP Front Flood Pot/Pot")
            updateSectionChestCountFromRoomSlotList(segment, "@Swamp Palace/Hookshot Key", {{54, 10}}, "@SP Hookshot Pot/Pot")
            updateSectionChestCountFromRoomSlotList(segment, "@Swamp Palace/Left Flood Key", {{53, 10}}, "@SP Left Flood Pot/Pot")
            updateSectionChestCountFromRoomSlotList(segment, "@Swamp Palace/Waterway Key", {{22, 10}}, "@SP Waterway/Pot")

            updateSectionChestCountFromRoomSlotList(segment, "@Skull Woods/West Lobby Key", {{86, 10}}, "@SW West Lobby/Pot")
            updateSectionChestCountFromRoomSlotList(segment, "@Skull Woods/Gibdo Key", {{57, 10}}, "@SW Gibdo/Gibdo")

            updateSectionChestCountFromRoomSlotList(segment, "@Thieves Town/Hallway Key", {{188, 10}}, "@TT Hallway/Pot")
            updateSectionChestCountFromRoomSlotList(segment, "@Thieves Town/Spike Switch Key", {{171, 10}}, "@TT Spike Switch/Pot")

            updateSectionChestCountFromRoomSlotList(segment, "@Ice Palace/Lobby Key", {{14, 10}}, "@IP Lobby/Bari")
            updateSectionChestCountFromRoomSlotList(segment, "@Ice Palace/Conveyor Key", {{62, 10}}, "@IP Conveyor/Bari")
            updateSectionChestCountFromRoomSlotList(segment, "@Ice Palace/Boulder Key", {{63, 10}}, "@IP Tongue Pull/Boulder")
            updateSectionChestCountFromRoomSlotList(segment, "@Ice Palace/Ice Hell Key", {{159, 10}}, "@IP Hell on Ice/Pot")

            updateSectionChestCountFromRoomSlotList(segment, "@Misery Mire/Spike Key", {{179, 10}}, "@MM Spike Room/Pot")
            updateSectionChestCountFromRoomSlotList(segment, "@Misery Mire/Fishbone Key", {{161, 10}}, "@MM Fishbone Room/Pot")
            updateSectionChestCountFromRoomSlotList(segment, "@Misery Mire/Conveyor Jelly", {{193, 10}}, "@MM Conveyor Switch/Bari")

            updateSectionChestCountFromRoomSlotList(segment, "@Turtle Rock/Chain Chomp Pokey", {{182, 10}}, "@TR Chain Chomp/Pokey")
            updateSectionChestCountFromRoomSlotList(segment, "@Turtle Rock/Lava Pokey", {{19, 10}}, "@TR Lava Pokey/Pokey")

            updateSectionChestCountFromRoomSlotList(segment, "@Ganon's Tower/Conveyor Bumper Key", {{139, 10}}, "@GT Conveyor Bumper/Pot")
            updateSectionChestCountFromRoomSlotList(segment, "@Ganon's Tower/Double Switch Key", {{155, 10}}, "@GT Double Switch/Pot")
            updateSectionChestCountFromRoomSlotList(segment, "@Ganon's Tower/Post-Compass Key", {{123, 10}}, "@GT Post-Compass/Pot")
            updateSectionChestCountFromRoomSlotList(segment, "@Ganon's Tower/Mini Helmasaur Key", {{61, 10}}, "@GT Mini Helmasaur/Mini Helmasaur")
        end
